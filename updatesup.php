...
<form action="updatesup.php" method="GET">

SupplierId<input type="text" name="supid" value="<?php echo $_GET['id']; ?>"/>
SupplierName<input type="text" name="supname" value="<?php echo $_GET['sn']; ?>"/>
...
if($_GET['submit'])
{
	...
	$ad1=$_GET['add'];
	$cn1=$_GET['cno'];
	$query="UPDATE SUPPLIER SET SUPPLIERNAME='$sn1', ADDRESS='$ad1' ,CONTACTNO='$cn1' WHERE  SUPPLIERID='$id1'";
