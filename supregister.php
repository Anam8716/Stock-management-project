...
<form action="supregister.php" method="GET">

SupplierName<input type="text" name="supname" value=""/>
...
if($_GET['submit'])
{
	...
	if($sn!=""&&$ad!=""&&$cno!="")
	{
	$query="INSERT INTO SUPPLIER VALUES ('','$sn','$ad','$cno')";
...
<form action="register.php" method="post">
	 <a href="supplier.php"><button type="button" ><<Back</button></a><br>
