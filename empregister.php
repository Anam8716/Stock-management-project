...
<form action="empregister.php" method="GET">
...
<br>Employee AdhaarNo:<br>
  <input type="text" name="adhaar" value="">
  <br>Hire Date:<br>
...
<a href="employee.php"><button style="background-color:indianred;color:white" type="button" ><< Go Back </button></a><br>
</form>
...
if($_GET['submit']){
	...
	if($emp!="" &&$add!="" &&$te!="" &&$an!="" &&$hd!="" &&$sk!="" &&$sal!="" )
	{
		$query="INSERT INTO employee values('','$emp','$add','$te','$an','$hd','$sk','$sal')";
